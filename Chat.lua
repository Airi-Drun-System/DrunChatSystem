...
InputContainer.Size = UDim2.new(1, -16, 0, 90)
InputContainer.Position = UDim2.new(0, 8, 1, -96)
...
print("═══════════════════════════════════════════════════════════")
print("🕷️ ТЁМНЫЙ ЧАТ ЗАГРУЖЕН (v8.8)")
